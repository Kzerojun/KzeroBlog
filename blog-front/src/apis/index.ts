...
import {PatchNicknameRequestDto, PatchProfileRequestDto} from "./request/user";
...
export const getBoardReqeust = async (boardNumber: number | string) => {
...
export const getLatestBoardListRqueust = async () => {
...
export const putFavoriteRequeust = async (boardNumber: number | string, accessToken: string) => {
...
export const deleteBoardRequeust = async (boardNumber: number | string, accessToken: string) => {
...
export const patchProfileImageRequest = async (requestBody: PatchProfileRequestDto, accessToken: string) => {
