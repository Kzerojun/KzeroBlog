...
export default function BoardDetail() {
  ...
  const increaseViewCountResponse = (responseBody: IncreaseViewCountResponseDto | ResponseDto | null) => {
    ...
    if (code === 'DBE') alert('존재하지 않는 게시물입니다.')
  }
...
//     component : 게시물 상세 상단 컴포넌트     //
  const BoardDetailTop = () => {
    ...
    // state : 작성자 여부 상태  //
    const [isWrtier, setWriter] = useState<boolean>(false);
    ...
    // function : get board resopnse 처리함수
    ...
    // function : delete board resopnse 처리함수
    ...
    const onDeleteButtonClickHandler = () => {
      ...
      deleteBoardRequeust(boardNumber, cookies.accessToken).then(deleteBoardResponse);
    }
    ...
    useEffect(() => {
      ...
      getBoardReqeust(boardNumber).then(getBoardResponse);
    }, [boardNumber]);
            ...
            <div className='board-detail-top-sub-box'>
              <div className='board-detail-write-info-box'>
                <div className='board-detail-writer-profile-image'
                     style={{backgroundImage: `url(${board?.writeProfileImage ? board.writeProfileImage : defaultProfileImage})`}}></div>
...
//     component : 게시물 상세 하단 컴포넌트     //
  const BoardDetailBottom = () => {
    ...
    // state :  페이지네이션 관련 상태  //
    const {
      currentPage, setCurrentPage, currentSection, setCurrentSection, viewList, viewPageList,
    ...
    const onFavoriteClickHandler = () => {
      ...
      putFavoriteRequeust(boardNumber, cookies.accessToken).then(putFavoriteResponse)
    }
    ...
    const onCommentSubmitButtonClickHandler = () => {
      if (!comment || !loginUser || !cookies.accessToken || !boardNumber) return;
          ...
          {showComment &&
              <div className='board-detail-bottom-comment-box'>
                <div className='board-detail-bottom-comment-container'>
                  ...
                  <div className='board-detai-bottom-comment-list-container'>
                    {viewList.map(item => <CommentItem commentListIem={item}/>)}
                  </div>
                </div>
                <div className='divider'></div>
                ...
                {loginUser !== null && <div className='board-detail-bottom-comment-input-box'>
                  <div className='board-detail-bottom-comment-input-container'>
                    <textarea ref={commentRef} className='board-detail-bottom-comment-textarea'
                              placeholder='댓글을 작성해주세요.' value={comment}
                              onChange={onCommentChangeHandler}/>
                    <div className='board-detail-bottom-comment-button-box'>
                      <div className={comment === '' ? 'disable-button' : 'black-button'}
                           onClick={onCommentSubmitButtonClickHandler}>{'댓글 달기'}</div>
                    </div>
                  </div>
                </div>}
