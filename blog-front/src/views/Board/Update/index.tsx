...
import './style.css'
import {userBoardStore, useLoginUserStore} from 'stores';
import {useNavigate, useParams} from 'react-router-dom';
import {MAIN_PATH} from 'constant';
import {useCookies} from "react-cookie";
import {getBoardReqeust} from 'apis';
        ...
        <div className='board-update-container'>
          <div className='board-update-box'>
            <div className='board-update-title-box'>
              <textarea className='board-update-title-textarea' ref={titleRef} rows={1}
            ...
            <div className='board-update-content-box'>
              <textarea ref={contentRef} className='board-update-content-textarea'
                        placeholder='본문을 작성해주세요.' value={content}
